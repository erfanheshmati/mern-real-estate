    ...
    return (
        <div className="flex flex-col md:flex-row">
            ...
            <div className="flex-1 mb-5">
                <h1 className="text-3xl font-semibold p-3 text-slate-700 mt-5">Search results:</h1>
                <div className="p-5 flex flex-wrap gap-4">
                    ...
                    {showMore && (<button onClick={onShowMoreClick} className="text-green-700 hover:underline w-full p-1 mt-6">Show more</button>)}
                </div>
            </div>
        </div >
    )
