    ...
    <>
      {landlord && (
        <div className="flex flex-col gap-2 mt-2">
          ...
          <textarea name="message" id="message" rows="2" placeholder="Enter your message here..." className="w-full border p-3 rounded-lg" value={message} onChange={onChange}></textarea>
